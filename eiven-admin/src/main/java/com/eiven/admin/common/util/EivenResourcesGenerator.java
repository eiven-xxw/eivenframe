 ...
 */
public class EivenResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        strategy.setSuperControllerClass("com.eiven.common.web.BaseController");
        // 表名生成策略
        ...
        pc.setParent("com.eiven.upms.admin");
